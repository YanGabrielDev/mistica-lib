...
const Select: React.FC<SelectProps> = ({
    ...
    const setValue = (val?: string, isSearch?: boolean) => {
    ...
    const removeUpperAndLowerCase = (str: string) => {
    ...
    const filterOptions = () => {
        const filteredOptions = selectOptions?.filter(({text}) => {
            const valueFormated = removeUpperAndLowerCase(value);

            const optionFormated = removeUpperAndLowerCase(text);
            return optionFormated.includes(valueFormated ?? '');
        });
                        ...
                        >
                            <Portal>
                                <ul
                                    ...
                                    ref={optionsMenuRef}
                                >
                                    {filterOptions().map(({value: val, text}) => (
                                        <li
                                            role="option"
